...
#MODEL_TAR_FILENAME = 'centernet_mobilenetv2fpn_512x512_coco17_od.tar.gz'
#CKPT_SUFFIX='301'



if MODEL_TAR_FILENAME == None:
...
ckpt.restore(os.path.join(PATH_TO_CKPT, 'ckpt-'+ CKPT_SUFFIX)).expect_partial()
